...
img_s0 = mapQuad(cleanedSNPIm, source_0_ps, full_scale_ps, 2);
img_s1 = mapQuad(cleanedSNPIm, source_1_ps, full_scale_ps, 2);
img_s2 = mapQuad(cleanedSNPIm, source_2_ps, full_scale_ps, 2);
